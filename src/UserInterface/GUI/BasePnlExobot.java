...
public class BasePnlExobot extends JPanel implements ActionListener{
    private Integer idExobot, idMaxExobot;
    private ExobotBL  exobotBL  = null;
    private ExobotDTO   exobot  = null;

    public BasePnlExobot() throws Exception{
        setGridBagLayout();
        loadData();
        showData();
        showTable();
    ...
    private void loadData() throws Exception {
        ...
        //idMaxExobot   = exobotBL.getMaxIdSoldado();
    }
    ...
    private void btnGuardarClick(ActionEvent e) throws  Exception {
        ...
        if (JOptionPane.showConfirmDialog(this, "¿Seguro que desea guardar?", (exobotNull)?"Agregar...": "Actualizar...", 
            ...
            // if (exobotNull)
            //     exobot = new ExobotBL(txtModelo.getText().toString());
            // else
            //     exobot.setNombre(txtModelo.getText().toString());

            // if(!((exobotNull) ? exobotBL.createSoldado(exobot) : exobotBL.updateSoldado(exobot)))
    ...
    private void showTable() throws Exception {
        ...
        table.getSelectionModel().addListSelectionListener(new ListSelectionListener(){ 
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                String strIdExobot = table.getModel().getValueAt(row, col).toString();
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == btnIni)
            idExobot  = 1;
        if(e.getSource() == btnAnt  &&  (idExobot>1) )
            idExobot--;
        if(e.getSource() == btnSig  &&  (idExobot<idMaxExobot))
            idExobot++;
